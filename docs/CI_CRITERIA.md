...
| Area / Criteria (summary) | How MintKit Hub addresses it |
|---------------------------|------------------------------|
| 5.1 Deployment | Final version deployed to Heroku with Postgres; deployment checked to match local development environment (Section 8 & [Deployment Documentation](../README.md#8-deployment-and-local-development)).
